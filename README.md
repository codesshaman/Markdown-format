...
В настоящее время в issues/discussions текст отбражается на разных строках, а в репозиториях отображается так, как показано выше. Ниже приведёни обходной путь.
### Обходной путь
```
> **Note** <br>
> Это примечание
